...
<head>
	...
	<title>Христианская миссия  -  VLASTAR</title>

  <style>
     #layer_f {position: fixed;}
...
<div id="layer4">
    <?php include "carusel_1.php"; ?>
  <?php include "text-home.php"; ?>
</div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-6">
        <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Товар ККК 111</h5>
              <p class="card-text">ОПИСАНИЕ товара ККК</p>
              <a href="#" class="btn btn-primary">ПЕРЕЙТИ ККК</a>
            </div>
        </div>
      </div>>     
    </div>>
